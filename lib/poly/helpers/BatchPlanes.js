...
var BatchPlanes = function (_Mesh) {
    ...
    function BatchPlanes() {
        ...
        var program = new POLY.Program(_planesDot2.default, _simpleColor2.default, {
            color: {
                type: 'vec3',
                value: [1., 1., 1.]
            },
        ...
        var _this = _possibleConstructorReturn(this, (BatchPlanes.__proto__ || Object.getPrototypeOf(BatchPlanes)).call(this, program, null, 0));
